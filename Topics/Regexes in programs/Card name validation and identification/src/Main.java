...
class BankCard {
    public static void main(String[] args) {
        ...
        String visaRegex = "^4[0-9]{12}(?:[0-9]{3})?$";// put your code here
        String masterCardRegex = "^(5[1-5][0-9]{14}|2(22[1-9][0-9]{12}|2[3-9][0-9]{13}|[3-6][0-9]{14}|7[0-1][0-9]{13}|720[0-9]{12}))$";// put your code here
